...
```{asis,echo = TRUE,eval = evalstatanal}
## Statistical data analysis
```

```{asis, echo = TRUE, eval = evalJoinedtatanal, warning=FALSE,message=FALSE,error=FALSE,results=FALSE}
# Volcano plot
```
...
req(DEA$reactives$selectedcomp)
req(DEA$reactives$selectedFC)
req(DEA$reactives$selectedPvalT)
...
ggplot <- ggplot(res, aes(x = estimate, y = -log10(p.value))) + 
  ...
  #volcanolist <- c(ggplot,volcanolist)
#}
plot(ggplot)
```
